...
export const SERVICOS_INICIAIS: SolicitacaoServico[] = [
  {
    ...
    horaPrevista: '08:30',
    tipoServico: 'Pulverização e Aplicação de Defensivos',
    descricao: 'Pulverização com fungicida preventivo no talhão 3 de milho safrinha (área de 80 ha).',
    status: 'agendada',
    observacoes: 'Condições climáticas favoráveis previstas para a manhã (vento brando).',
    valor: 4800,
  ...
  },
  {
    ...
    dataPrevista: '2026-09-14', // Hoje!
    horaPrevista: '14:00',
    tipoServico: 'Gradagem e Preparo de Solo',
    descricao: 'Preparo profundo do solo para plantio da primeira safra no Gleba Norte.',
  ...
  },
  {
    ...
    horaPrevista: '09:00',
    tipoServico: 'Análise de Solo e Calagem',
    descricao: 'Coleta de amostras de solo georreferenciadas nos talhões de café arábica e dosagem de calcário.',
    status: 'agendada',
    observacoes: 'Enviar laudo laboratorial para o e-mail da agrônoma responsável.',
    valor: 2200,
  ...
  },
  {
    ...
    horaPrevista: '07:00',
    tipoServico: 'Plantio Mecanizado de Soja',
    descricao: 'Operação com 2 plantadeiras pneumáticas de 24 linhas nos talhões 1 e 2.',
    status: 'agendada',
    observacoes: 'Sementes tratadas já disponíveis no barracão principal.',
    valor: 18500,
  ...
  },
  {
    ...
    horaPrevista: '10:00',
    tipoServico: 'Colheita Mecanizada',
    descricao: 'Colheita mecanizada de safra de milho com 2 colheitadeiras axiais.',
  ...
  },
  {
    ...
    horaPrevista: '11:00',
    tipoServico: 'Adubação de Cobertura',
    descricao: 'Distribuição de ureia protegida na linha de plantio do milho.',
    status: 'pago',
  ...
  },
  {
    ...
    horaPrevista: '13:30',
    tipoServico: 'Consultoria Agronômica e Manejo de Pastagem',
    descricao: 'Vistoria técnica para dimensionamento de piquetes rotacionados de capim mombaça.',
    status: 'agendada',
    observacoes: 'Visita técnica com elaboração de mapa de piqueteamento.',
    valor: 2800,
  ...
  },
  {
    ...
    horaPrevista: '15:00',
    tipoServico: 'Subsolagem e Descompactação',
    descricao: 'Serviço de descompactação de solo em pastagem degradada.',
    status: 'realizada',
  ...
  },
  {
    ...
    horaPrevista: '08:00',
    tipoServico: 'Poda e Desbrota de Cafezais',
    descricao: 'Poda tipo esqueletamento em lavoura de 10 anos.',
    status: 'pago',
  ...
  },
  {
    ...
    horaPrevista: '16:00',
    tipoServico: 'Manutenção de Maquinário Agrícola',
    descricao: 'Revisão hidráulica e troca de bicos da barra de pulverização de 36 metros.',
    status: 'realizada',
    observacoes: 'Peças instaladas sob garantia.',
    valor: 3100,
  ...
  },
  {
    ...
    horaPrevista: '10:00',
    tipoServico: 'Vistoria Fitossanitária',
    descricao: 'Monitoramento de pragas e lagarta-do-cartucho.',
    status: 'agendada',
    observacoes: 'Utilização de armadilhas com feromônio.',
    valor: 1500,
